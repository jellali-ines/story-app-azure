...
async function sendMail(user,password,type) {
                        ...
                        <tbody>
                          <tr>
                            <td style="width:150px;">
                              <img alt="image description" height="auto" src="https://codedmails.com/images/logo-black.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="150" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:550px;">
                              <img alt="welcome image" height="auto" src="D:/stories/Kids_Story_AI/dashboard-admin/assets/img1.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="550" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
    ...
    <div style="margin:0px auto;max-width:600px;">
                            ...
                            <tbody><tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                  <h1 style="margin: 0; font-size: 32px; line-height: 40px;">Hi ${user.user_name}! <br />We are excited to welcome you to <strong>StoryTeller for Kids</strong>, your new interactive platform for magical children’s stories!</h1>
                                </div>
                              </td>
                            </tr>
                          </tbody></table>
          ...
          <![endif]-->
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Alata;font-size:18px;font-weight:bold;line-height:24px;text-align:left;color:#000000;">
                                  <p class="date" style="margin: 0; margin-bottom: 5px; font-size: 14px;">${Date.now()}</p>
                                  <h2 style="margin: 0; font-size: 24px; line-height: 30px;">Your Account Details</h2>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                  <p style="margin: 0;"> <strong>Login:</strong> ${user.email} <br>
                             ...
                             <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                ...
                                <h3>Subscription Confirmation</h3>
                                  <h2 style="margin: 0; font-size: 24px; line-height: 30px;"> Thank you for your payment! Your subscription has been successfully activated.  </h2>
                                </div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                  <p style="margin: 0;"> <strong>Subscription Type:</strong> ${user.payment_history[0].payment_type}
                                    <br>
                                    <strong>Amount Paid:</strong> ${user.payment_history[0].amount}
                                    <br>
                                    <strong>Subscription Start:</strong> ${user.payment_history[0].datePayment}
                                    <br>
                                    <strong>Subscription Expiration:</strong> ${user.payment_expires_date} </p>
                                </div>
                              </td>
                            </tr>
                            <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                  <tbody><tr>
                                    <td align="center" bgcolor="#ea4a40" role="presentation" style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#ea4a40;" valign="middle">
                                      <a href="https://google.com" style="display: inline-block; background: #ea4a40; color: #ffffff; font-family: Alata; font-size: 14px; font-weight: bold; line-height: 30px; margin: 0; text-decoration: none; text-transform: uppercase; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 3px;" target="_blank">
      ...
      >
        <tr>
          <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
      <![endif]-->
              <div style="background:#ea4a40;background-color:#ea4a40;margin:0px auto;border-radius:4px;max-width:520px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#ea4a40;background-color:#ea4a40;width:100%;border-radius:4px;">
                  <tbody>
                    <tr>
                      <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                        <!--[if mso | IE]>
                              ...
                              <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                  <tbody>
                                    <tr>
                                      <td style="width:50px;">
                                        <img alt="image description" height="auto" src="https://codedmails.com/images/logo-circle-gray.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;" width="50" />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
...
<body style="background-color:#ffffff;">
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                  <p style="margin: 0;"> <strong>Subscription Type:</strong> ${user.payment_history[user.payment_history.length - 1].payment_type}
                                    <br>
                                    <strong>Amount Paid:</strong> ${user.payment_history[user.payment_history.length - 1].amount}
                                    <br>
                                    <strong>Subscription Start:</strong> ${user.payment_history[user.payment_history.length - 1].datePayment}
                                    <br>
                                    <strong>Subscription Expiration:</strong> ${user.payment_expires_date} </p>
                                </div>
                              </td>
  ...
  await transporter.sendMail({
    from: "zeinebchekir742@gmail.com",
    to: user.email,
    subject: "Bienvenue 🎉",
    html: type=="create"? htmlCreate:htmlPayment
  });
}
